...
Un texto plano, antes de transmitirlo al destintario, podríamos cifrarlo con la clave pública. El receptor del mensaje, poseedor de la clave privada, podría descifrar el mensaje. Esto también funciona a la inversa, es decir, si ciframos el mensaje con la clave privada podrá ser descifrado mediante la clave pública.
